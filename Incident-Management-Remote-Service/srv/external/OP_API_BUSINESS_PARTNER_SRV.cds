/* checksum : f423aaf21109f55026b2b734bd6cb784 */
@cds.external : true
...
service OP_API_BUSINESS_PARTNER_SRV {
  ...
  @cds.persistence.skip : true
  @sap.content.version : '1'
  @sap.label : 'Tax Compliance'
  entity A_BPTaxCompliance {
    @sap.display.format : 'UpperCase'
    @sap.label : 'Business Partner'
    @sap.quickinfo : 'Business Partner Number'
    key BusinessPartner : String(10) not null;
    @sap.display.format : 'UpperCase'
    @sap.label : 'ID'
    @sap.quickinfo : 'Tax Compliance ID'
    key BPTaxComplianceID : String(6) not null;
    @sap.display.format : 'UpperCase'
    @sap.label : 'Type'
    @sap.quickinfo : 'Tax Compliance Type'
    BPTaxComplianceType : String(6);
    @sap.display.format : 'UpperCase'
    @sap.label : 'Country/Region'
    @sap.quickinfo : 'Tax Compliance: Country/Region'
    BPTaxComplianceCountryRegion : String(3);
    @sap.display.format : 'UpperCase'
    @sap.label : 'Region'
    @sap.quickinfo : 'Tax Compliance: Region'
    BPTaxComplianceRegion : String(3);
    @sap.display.format : 'UpperCase'
    @sap.label : 'Status'
    @sap.quickinfo : 'Tax Compliance Status'
    BPTaxComplianceStatus : String(1);
    @sap.display.format : 'UpperCase'
    @sap.label : 'Reason'
    @sap.quickinfo : 'Tax Compliance: Reason for Status'
    BPTaxComplianceStatusReason : String(2);
    @sap.display.format : 'Date'
    @sap.label : 'Valid From'
    @sap.quickinfo : 'Tax Compliance: Start Date'
    BPTaxComplianceValidFromDate : Date;
    @sap.display.format : 'Date'
    @sap.label : 'Valid To'
    @sap.quickinfo : 'Tax Compliance: End Date'
    BPTaxComplianceValidToDate : Date;
    @sap.display.format : 'Date'
    @sap.label : 'Rating Date'
    @sap.quickinfo : 'Tax Compliance: Rating Date'
    BPTaxComplianceRatingDate : Date;
    @sap.display.format : 'UpperCase'
    @sap.label : 'Agreement'
    @sap.quickinfo : 'Tax Compliance: Agreement Status'
    BPTaxComplianceAgreementStatus : String(1);
    @sap.display.format : 'Date'
    @sap.label : 'Agreement Date'
    @sap.quickinfo : 'Tax Compliance: Agreement Date'
  ...
  entity A_BusinessPartner {
    ...
    to_BPTaxCompliance : Association to many A_BPTaxCompliance {  };
