...
## Extend the Incident Management Application with New Service

1. Under `srv`, create a new file called `ticket-admin.cds` and paste the content from below.
...
2. Under `srv`, create handler for the `TicketService` with file called `ticket-admin.js` and paste the content from below.
...
[Add Fiori UI application with attachments](./extended-ui.md)