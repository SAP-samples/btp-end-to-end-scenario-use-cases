...
4. For this handson we have already set up [Register an SAP S/4HANA Cloud system in your SAP SAP Business Technology Platform (BTP)](./s4hana-cloud-to-btp-connectivity.md).
